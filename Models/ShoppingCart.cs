...
namespace WecareMVC.Models
{
    public partial class ShoppingCart
    {
        ...
        public int RemoveFromCart(int id)
        {
            ...
            if (cartItem != null)
            {
                //if (cartItem.Count > 1)  一次減一個Title
                //{
                //    cartItem.Count--;
        ...
        public List<Cart> GetCartItems()   //取得現在在購物車內的Title
        {
        ...
        public int GetCount()   //取得Title數量，顯示在首頁
        {
        ...
        public int CreateOrder(Order order, decimal disCount)   //把每一筆購買Title記錄到order中
        {
            decimal orderTotal = 0;

            var cartItems = GetCartItems();  //先取得所有Title
